...
output = magics.output(output_formats= ['pdf', 'svg', "png"],
...
map = magics.mmap(
	...
	page_id_line = False, subpage_frame = False) #, subpage_map_projection = "robinson", subpage_frame = False)

text = magics.mtext(text_lines = ["magpye"], 
    text_justification  = 'left',
    text_font_size      = 3.0,
    text_box_blanking   = False,
    text_mode           = "positional",
    text_box_x_position = 2., 
...
for triangle in triangles:
    ...
    geo = magics.minput(input_type = "geographical", 
